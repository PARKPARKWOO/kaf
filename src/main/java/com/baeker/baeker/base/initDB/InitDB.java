...
//        initService.init_dummy_user();
    ...
    static class InitService {
        ...
        public void init_alpha_and_study() throws IOException, ParseException {
            ...
            // user 알파와 알파의 스터디 생성
//            Member alpha = createMember("user1", "알파", "안녕하세요 알파입니다.", "https://avatars.dicebear.com/api/avataaars/600.svg", "wy9295");
//
...
//            Member member = new Mem;
            MemberJoinForm memberJoinForm = new MemberJoinForm("wy9295", "wy9295", "wy9295", "wy9295", "wy9295", "wy9295");
            RsData<Member> join = memberService.join(memberJoinForm);
            memberService.connectBaekJoon(join.getData().getId(), join.getData().getBaekJoonName());
...
//            }
        ...
        public void create(Long id, String baekjoon) {
            memberService.connectBaekJoon(id,baekjoon);
        }
...
//            }
//            memberService.connectBaekJoon(member.getId(), baekJoonName);
