...
public class InitDB {
    ...
    static class InitService {
        ...
        public void init_alpha_and_study() {
            ...
            // user 알파와 알파의 스터디 생성
            Member alpha = createMember("user1", "알파", "안녕하세요 알파입니다.", "");
            ...
            for (int i = 3; i < 10; i++) {
                Member member = createMember("user" + i, "member" + i, "안녕하세요" + i, "");
        ...
        public void init_beta_and_study() {
            ...
            // user 베타와 베타의 스터디 생성
            Member beta = createMember("user2", "베타", "안녕하세요 베타입니다.", "");
        ...
        public void init_dummy_user() {
            ...
            // 스터디가 없는 더미 유저 5명 생성
            for (int i = 0; i < 5; i++)
                createMember("dummy" + i, "dummy" + i, "안녕하세요" + i, "");
        }
